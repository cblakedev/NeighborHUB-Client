                ...
                <Router>
                    <Row className='headerBar g-0'>
                        <Col className='homeBtn'>
                            <span onClick={(e) => this.handleCanvasShow()}><GiHamburgerMenu /></span> {/* Responsive hamburger icon. */}
                            <h3 className='headerTitle'><a href='/'>NeighborHUB</a></h3>
                        </Col>

                        {/* Reponsive canvas toggleable by the hamburger icon for smaller viewports.  */}
                    ...
                    <Container className='mainHomeWrapper'>
                        <Row className='homeWrapper'>
                            ...
                            {/* Routes corresponding to the main sidebar links. */}
